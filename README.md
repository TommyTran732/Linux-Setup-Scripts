...
Please run the script as your actual user and not root. Provide sudo password when it asks you to. Flatpak packages nd themes/icons are only installed for your user and not system wide. <br />
